...
variable "db_secret_arn" {
  description = "ARN of AWS Secrets Manager secret containing RDS credentials from RDS account. Get with: aws secretsmanager list-secrets --query 'SecretList[?Name==`rds-db-credentials`].ARN' --output text"
  type        = string
}
